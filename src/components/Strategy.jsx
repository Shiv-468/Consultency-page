    ...
    <div className=" bg-StrategyBG bg-cover bg-no-repeat bg-center md:min-h-[848px]">
        <div className=" max-w-[1164px] px-3 mx-auto pt-16 md:pt-[111px]">
            <div className=" flex flex-wrap sm:flex-nowrap justify-center gap-6 lg:gap-0" data-aos="flip-down">
                <div className=" max-w-[400px] px-8 sm:max-w-[250px] md:min-h-[200px] py-12 flex md:pt-[61px] justify-center bg-[#FFFFFF26] w-full hover:bg-[#003E92] duration-300 ease-linear ">
                    <p className=' text-base leading-[25.6px] font-Poppins font-normal sm:max-w-[173px] text-white'>How do I let go of my EX so I can finally leave him behind?</p>
                </div>
                <div className=" max-w-[400px] px-8 sm:max-w-[250px] md:min-h-[200px] py-12 flex md:pt-[61px] justify-center bg-[#FFFFFF26] w-full hover:bg-[#003E92] duration-300 ease-linear ">
                    <p className=' text-base leading-[25.6px] font-Poppins font-normal sm:max-w-[173px] text-white'>How does the divorce process work?</p>
                </div>
               <div className=" hidden md:block w-full max-w-[250px]">
               <div className=" max-w-[400px] px-8 sm:max-w-[250px] md:min-h-[200px] py-12 h-full flex md:pt-[61px] justify-center bg-[#FFFFFF26] w-full hover:bg-[#003E92] duration-300 ease-linear ">
                    <p className=' text-base leading-[25.6px] font-Poppins font-normal sm:max-w-[173px] text-white'>Do I need a lawyer?</p>
                </div>
               </div>
            </div>
            <div className=" flex flex-wrap justify-center pt-6 md:pt-[34px] gap-6 lg:gap-0" data-aos="flip-down">
                <div className=" max-w-[400px] px-8 sm:max-w-[250px] md:min-h-[200px] py-12 flex md:pt-[61px] justify-center bg-[#FFFFFF26] w-full hover:bg-[#003E92] duration-300 ease-linear ">
                    <p className=' text-base leading-[25.6px] font-Poppins font-normal sm:max-w-[173px] text-white'>How much will the divorce cost?</p>
                </div>
                <div className=" max-w-[400px] px-8 sm:max-w-[250px] md:min-h-[200px] py-12 flex md:pt-[61px] justify-center bg-[#FFFFFF26] w-full hover:bg-[#003E92] duration-300 ease-linear ">
                    <p className=' text-base leading-[25.6px] font-Poppins font-normal sm:max-w-[173px] text-white'>What will happen to my children?</p>
                </div>
                <div className=" max-w-[400px] px-8 sm:max-w-[250px] md:min-h-[200px] py-12 flex md:pt-[61px] justify-center bg-[#FFFFFF26] w-full hover:bg-[#003E92] duration-300 ease-linear ">
                    <p className=' text-base leading-[25.6px] font-Poppins font-normal sm:max-w-[173px] text-white'>What does my future as a single person look like now?</p>
                </div>
                <div className=" max-w-[400px] px-8 sm:max-w-[250px] md:min-h-[200px] py-12 flex md:pt-[61px] justify-center bg-[#FFFFFF26] w-full hover:bg-[#003E92] duration-300 ease-linear ">
