    ...
    <div className=" max-w-[1164px] px-3 mx-auto pt-[71px] pb-[59px] ">
        <div className=" flex flex-wrap -mx-3">
            <div className=" w-[58.33%] px-3">
                <h2 className=' text-[52px] leading-[66.9px] font-Helvetica font-normal uppercase '>Request your</h2>
                <h2 className=' text-[52px] leading-[66.9px] font-Helvetica font-normal uppercase '><span className=' text-[#F77B0B]'>non-binding</span> strategy</h2>
                <h2 className=' text-[52px] leading-[66.9px] font-Helvetica font-normal uppercase '>meeting now!</h2>
            </div>
            <div className=" w-[41.66%] px-3 flex items-center justify-end">
             <div className=" flex gap-[14px]">
                <div className=" bg-[#9800B0] w-[2px]"></div>
                <p className=' text-base leading-[25.6px] font-Poppins font-normal max-w-[398px] '>Click on the button below, choose an appointment and answer the questions truthfully. One of our strategy consultants will then contact you and conduct your free consultation. We can advise you on the following topics: </p>
             </div>
            </div>
        </div>
    </div>
    <div className=" bg-StrategyBG bg-cover bg-no-repeat bg-center min-h-[848px]">
        <div className=" max-w-[1164px] px-3 mx-auto  pt-[111px]">
            <div className=" flex flex-wrap justify-center">
                <div className=" max-w-[250px] min-h-[200px] flex pt-[61px] justify-center bg-[#FFFFFF26] w-full hover:bg-[#003E92] duration-300 ease-linear ">
            ...
            <div className=" flex flex-wrap justify-center pt-[34px]">
                <div className=" max-w-[250px] min-h-[200px] flex pt-[61px] justify-center bg-[#FFFFFF26] w-full hover:bg-[#003E92] duration-300 ease-linear ">
          ...
          <div className=" flex items-center justify-center pt-[58px] pb-[186px]">
