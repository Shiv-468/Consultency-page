       ...
       <p className=' font-normal font-Helvetica text-[40px] leading-[51.5px] rotate-[-270deg]'>04</p>
        ...
        <div className=" flex flex-wrap -mx-3">
          <div className="w-full lg:w-[50%] xl:w-[41.66%] px-3 md:pe-0 md:ps-[6px] flex flex-col items-center lg:items-start pb-6 lg:pb-0"  data-aos="fade-right">
            ...
            <button class="bg-gradient-to-tr from-blue-500 to-purple-500 hover:shadow-BtnShadow duration-300 ease-in-out font-medium mt-9 sm:max-w-[452px] rounded-[63px] p-[1.7px]">
              <span class="flex gap-1 items-center py-[5px] ps-[9px] sm:pe-[48px] w-full bg-white text-black rounded-[63px] ">
                <img src={Chatting} alt="Chatting" />
                <span class="bg-gradient-to-r from-[#0C5FD1] to-[#8703C5] sm:inline-block text-transparent bg-clip-text text-start font-Inter font-medium text-[16px] leading-[24px]">Book a non-binding initial consultation now</span>
              </span>
            </button>
          </div>
