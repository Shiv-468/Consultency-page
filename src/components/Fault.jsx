...
const Fault = () => {
    return (
        <section className=' md:pt-[151px] pb-12 sm:pb-[80px] md:pb-[122px] relative'>
            <img src={FaultEllipse} alt="FaultEllipse" className=' absolute right-0 top-[6%] max-xl:opacity-55 hidden md:block' />
         ...
         <div className=" flex flex-col">
          ...
          <div className=" flex gap-[14px] items-center lg:ps-9">
                <div className=" bg-[#9800B0] w-[2px] sm:min-h-[67.8px]"></div>
                <p className=' text-base leading-[25.6px] font-Poppins font-normal sm:max-w-[288px] text-center sm:text-start '>It's not your fault for not knowing how to let go of the partner who no longer made you feel special. </p>
             </div>
          </div>
               </div>
           ...
           <div className=" max-w-[750px] w-full flex flex-wrap min-h-[162px]" data-aos="flip-up">
            ...
            <div className=" max-w-[1164px] px-3 mx-auto">
                ...
                <button class="bg-gradient-to-tr from-blue-500 to-purple-500 text-white font-medium max-w-[452px] rounded-[63px] p-[1.7px]" data-aos="zoom-in">
