  ...
  return (
    <section className=' max-xl:min-h-screen md:bg-HeroBG bg-white flex bg-cover bg-no-repeat bg-center xl:!min-h-[810px] 2xl:!min-h-[90vh] relative'>
      ...
      <div className=" max-w-[1164px] px-3 mx-auto w-full flex relative flex-col">
        ...
        <nav>
          <div className=" flex items-center justify-end pt-6">
            <ul className={`${data ? "right-0":"right-[-100%]"} menuicon flex items-center gap-10 z-50 max-md:bg-[#003E92] max-md:fixed max-md:h-full max-md:w-full max-md:top-0 max-md:flex-col max-md:justify-center max-md:duration-300`}>
              <li><a href="" className=' text-base text-white leading-[20.6px] font-Helvetica font-normal md:hover:text-black duration-300 ease-linear'>Benifits</a></li>
              <li><a href="" className=' text-base text-white leading-[20.6px] font-Helvetica font-normal md:hover:text-black duration-300 ease-linear'>Testimonials</a></li>
              ...
              <div onClick={view} className=" md:hidden z-50">
              <Hamburger  onClick={view} toggled={isOpen} toggle={setOpen} />
              </div>
          </div>
        </nav>
       ...
       <button class="bg-gradient-to-tr from-blue-500 to-purple-500 max-w-[452px] lg:max-w-[452px] text-white font-medium md:max-w-[280px] rounded-[63px] p-[1.7px]">
              <span class="flex gap-1 items-center py-[5px] ps-[9px] pe-[20px] xl:pe-[48px] w-full bg-white text-black rounded-[63px]  font-inter font-medium text-[16px] leading-[24px] ">
