...
const HeroSection = () => {
  ...
  return (
    <section className=' min-h-[810px] md:bg-HeroBG bg-white flex bg-cover bg-no-repeat bg-center xl:!min-h-[810px] relative'>
      ...
      <div className=" max-w-[1164px] px-3 mx-auto w-full flex relative flex-col">
       <div className=" absolute bottom-[-14%] md:bottom-[-19%] lg:bottom-[-25%] xl:bottom-[-21.5%] hidden md:block" data-aos="fade-down-right">
       <img src={MJH1} alt="MJH1" className=' relative md:h-[200px] lg:h-auto' />
       ...
       <p className=' font-normal font-Helvetica text-[24px] leading-[30.9px] uppercase'>fault</p>
        ...
        <nav>
          <div className=" flex items-center justify-end pt-6">
            <ul className={`${data ? "right-0":"right-[-100%]"} menuicon flex items-center gap-10 z-50 max-md:bg-[#003E92B2] max-md:backdrop-blur-[30px] max-md:fixed max-md:h-full max-md:w-full max-md:top-0 max-md:flex-col max-md:justify-center max-md:duration-300`}>
              ...
              <li><button className=' text-nowrap flex items-center capitalize justify-center max-w-[235px] px-[28.2px] text-white w-full min-h-[56px] bg-gradient-to-br from-[#0C5FD1] to-[#8703C5] transition duration-300 ease-in-out hover:bg-gradient-to-br hover:from-[#8703C5] hover:to-[#0C5FD1]'>Book consultation now</button></li>
            </ul>
        ...
        <div className=" flex flex-wrap -mx-3 md:items-center md:justify-center md:flex-grow lg:h-full">
       ...
       <button class="bg-gradient-to-tr from-blue-500 to-purple-500 max-w-[452px] lg:max-w-[400px] hover:shadow-BtnShadow duration-300 ease-in-out w-full xl:max-w-[452px] text-white font-medium md:max-w-[280px] rounded-[63px] p-[1.7px]">
              <span class="flex gap-1 items-center py-[5px] ps-[9px] pe-[16px] w-full bg-white text-black rounded-[63px]  font-Inter font-medium text-[16px] leading-[24px] ">
                <img src={Chatting} alt="Chatting" />
                <span class="bg-gradient-to-r from-[#0C5FD1] to-[#8703C5] text-start capitalize text-transparent bg-clip-text">Book a non-binding initial consultation now</span>
              </span>
            </button>
          ...
          <div className=" w-full md:w-[50%] px-3 md:justify-end flex flex-col pt-6 md:pt-0 md:h-full" data-aos="fade-left">
            <div className=" flex md:pb-[45.8px] md:justify-center ps-5">
              <div className=" flex flex-col sm:flex-row justify-between max-w-[367px] border-l-[2px] border-[#9800B0]">
                <p className=' md:text-white ps-[13px] font-Helvetica text-base leading-[27.2px] font-normal sm:max-w-[165px] uppercase'>Die wichtigsten Aspekte einer Trennung:</p>
                <div className=" flex flex-col">
                  <ul className=' ps-8'>
                    <li className=' font-Poppins font-medium text-base leading-[25.6px] md:text-white list-disc capitalize'>physische Trennung</li>
                    <li className=' font-Poppins font-medium text-base leading-[25.6px] md:text-white list-disc capitalize'>mentale Trennung</li>
                  </ul>
                </div>
              </div>
            </div>
