  ...
  return (
    ...
    <section className=' bg-FindoutBG bg-no-repeat bg-cover bg-left lg:bg-center min-h-[517px] flex flex-col justify-center'>
        <div className=" px-3 flex items-center justify-center">
            <div className=" max-w-[778px] min-h-[305px] backdrop-blur-[5px] flex flex-col items-center bg-[#FFFFFF26] border border-[#FFFFFF26] w-full px-4 sm:px-6 py-10 sm:pt-[50px] sm:pb-[42.8px]" data-aos="zoom-out">
                ...
                <button className=' flex items-center max-w-[193px] rounded-[68px] mt-5 sm:mt-[31px] min-h-[56px] justify-center w-full  bg-gradient-to-r from-[#0C5FD1] to-[#8703C5] hover:shadow-white hover:shadow-md duration-300 ease-in-out'>
                <span className='text-white capitalize'>Let’s find it out</span>
                </button>
            </div>
        </div>
    </section>
